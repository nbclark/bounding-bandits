...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
	...
	void (^httpCompletionBlock)(ASIHTTPRequest * reuqest);

	//block to execute when request fails
	void (^failureBlock)(ASIHTTPRequest * reuqest);
...
- (void)setHTTPCompletionBlock:(void(^)(ASIHTTPRequest*))aCompletionBlock;
